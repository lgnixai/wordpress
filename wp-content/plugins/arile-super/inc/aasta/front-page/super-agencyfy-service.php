...
$aasta_service_area_title = get_theme_mod('aasta_service_area_title', __('We are the one of the most effective IT Companies','arile-super'));
			...
			{ ?>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content wow animate fadeInUp" data-wow-delay=".3s">
						...
						<h5 class="service-title text-center"><a href="#"><?php esc_html_e('SEO Optimization','arile-super'); ?></a></h5>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content wow animate fadeInUp" data-wow-delay=".3s">
						...
						<h5 class="service-title text-center"><a href="#"><?php esc_html_e('Marketing','arile-super'); ?></a></h5>
						<p class="text-center"><?php esc_html_e('Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.','arile-super'); ?></p>		
					</article>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content wow animate fadeInUp" data-wow-delay=".3s">
						...
						<h5 class="service-title text-center"><a href="#"><?php esc_html_e('Web Design','arile-super'); ?></a></h5>
						<p class="text-center"><?php esc_html_e('Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.','arile-super'); ?></p>
					</article>
				</div>
