...
$aasta_service_area_title = get_theme_mod('aasta_service_area_title', __('BEST CONSTRUCTION SERVICES','arile-super'));
		...
		foreach ( $aasta_service_content as $features_item ) {
			...
			{ ?>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content wow animate fadeInUp" data-wow-delay=".3s">
						<figure class="service-content-thumbnail text-center">
							<a href="#"><img class="img-fluid" src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-service16.jpg" alt="SEO Friendly" title="SEO Friendly"></a>
						</figure>
				...
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content wow animate fadeInUp" data-wow-delay=".3s">
						<figure class="service-content-thumbnail text-center">
							<a href="#"><img class="img-fluid" src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-service17.jpg" alt="Translation & RTL Ready" title="Translation & RTL Ready"></a>
						</figure>
						<h5 class="service-title text-center"><a href="#"><?php esc_html_e('DESIGN AND BUILD','arile-super'); ?></a></h5>
						<p class="text-center"><?php esc_html_e('Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.','arile-super'); ?></p>		
					</article>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content wow animate fadeInUp" data-wow-delay=".3s">
						<figure class="service-content-thumbnail text-center">
							<a href="#"><img class="img-fluid" src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-service18.jpg" alt="Creative Design" title="Creative Design"></a>
						</figure>
						<h5 class="service-title text-center"><a href="#"><?php esc_html_e('OFFICE DESIGN','arile-super'); ?></a></h5>
						<p class="text-center"><?php esc_html_e('Lorem Ipsum is simply text of the printing and typesetting industry. Lorem Ipsum has been standard dummy.','arile-super'); ?></p>
					</article>
				</div>
