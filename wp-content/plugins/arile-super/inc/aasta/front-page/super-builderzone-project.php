...
$aasta_project_area_des = get_theme_mod('aasta_project_area_des', __('Construction Works','arile-super'));
			...
			<div class="row theme-project-row">		
				...
				<?php } } else { ?>
							...
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project13.jpg" class="img-fluid" alt="BEDROOM LIGHTING DÉCOR">
										<div class="content-overlay"></div>
										<div class="click-view">
							...
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project14.jpg" class="img-fluid" alt="EXTERIOR RENOVATION">
										<div class="content-overlay"></div>
										<div class="click-view">
										<h5 class="theme-project-title"><?php esc_html_e('Furniture Design','arile-super'); ?></h5>
										</div>
									</figure>
								</article>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project15.jpg" class="img-fluid" alt="ARCHITECTURE DESIGN">
										<div class="content-overlay"></div>
										<div class="click-view">
										<h5 class="theme-project-title"><?php esc_html_e('Project Planning','arile-super'); ?></h5>
										</div>
									</figure>
								</article>
							</div>	
							<div class="col-lg-3 col-md-6 col-sm-12">	
								<article class="theme-project-content wow animate zoomIn" data-wow-delay=".3s">
									<figure class="portfolio-thumbnail">
										<img src="<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-project16.jpg" class="img-fluid" alt="ARCHITECTURE DESIGN">
										<div class="content-overlay"></div>
										<div class="click-view">
										<h5 class="theme-project-title"><?php esc_html_e('Roof Remodel','arile-super'); ?></h5>
										</div>
									</figure>
								</article>
							</div>
