...
<section class="theme-main-slider" id="theme-slider">
    <div id="theme-main-slider" class="owl-carousel owl-theme">
		<?php 
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide18.jpg);">
				<div class="container theme-slider-content">
					<div class="theme-text-center theme-caption-bg align-center">
					    <h5 class="sub-title"><?php esc_html_e('We provide great ideas to','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('Grow your business fast ','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e('GlobalHub is a most popular Multipurpose WordPress themes in the world. The designs are clean, modern, and feature strong default colors that inspire confidence.','arile-super'); ?></p>
						<div class="mt-3 pt-3">
