...
<section class="theme-main-slider" id="theme-slider">
    <div id="theme-main-slider" class="owl-carousel owl-theme">
		<?php 
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide23.jpg);">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg">
					    <h5 class="sub-title"><?php esc_html_e('WELCOME TO','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('IT Agency & Company','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e('Many firms publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum infancy.','arile-super'); ?></p>
						<div class="mt-3 pt-3">
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide7.jpg">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg">
						...
						<h1 class="title-large"><?php esc_html_e('Web Design, Marketing & Branding','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e('Many firms publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for lorem ipsum infancy.','arile-super'); ?></p>
						<div class="mt-3 pt-3">
							<a href="#" class="btn-slider"><?php esc_html_e('Check it out','arile-super'); ?></a>
						</div>							
