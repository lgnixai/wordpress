...
<section class="theme-main-slider" id="theme-slider">
    <div id="theme-main-slider" class="owl-carousel owl-theme">
		<?php 
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide19.jpg);">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg2">
					    <h5 class="sub-title"><?php esc_html_e('Growth Your Business','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('Strategy and growth solutions for business','arile-super'); ?></h1>
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide20.jpg">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg2">
					    <h5 class="sub-title"><?php esc_html_e('Growth With Us','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('Take Your Business Online','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e('We provide all types of business solutions and services to our valuable customers for the growth of their businesses to the next level.','arile-super'); ?></p>
						<div class="mt-3 pt-3">
							<a href="#" class="btn-slider"><?php esc_html_e('Check it out','arile-super'); ?></a>
						</div>							
