...
<section class="theme-main-slider" id="theme-slider">
    <div id="theme-main-slider" class="owl-carousel owl-theme">
		<?php 
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide16.jpg);">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg">
					    <h5 class="sub-title"><?php esc_html_e('WE ARE THE BEST TEAM OF','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('Construction Industry','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e('We provide all types of construction and architecture services such as exterior design, house design, kitchen design, room design, furniture design, light design, etc. With the help of this, you can build your dream house.','arile-super'); ?></p>
						<div class="mt-3 pt-3">
			...
			<div class="item" style="background-image:url(<?php echo arile_super_plugin_url; ?>/inc/aasta/images/theme-slide17.jpg">
				<div class="container theme-slider-content">
					<div class="theme-text-left theme-caption-bg">
					    <h5 class="sub-title"><?php esc_html_e('Explore the Features','arile-super'); ?></h5>
						<h1 class="title-large"><?php esc_html_e('Innovative Solution','arile-super'); ?></h1>
						<p class="description"><?php esc_html_e('We provide all types of construction and architecture services such as exterior design, house design, kitchen design, room design, furniture design, light design, etc. With the help of this, you can build your dream house.','arile-super'); ?></p>
						<div class="mt-3 pt-3">
							<a href="#" class="btn-slider"><?php esc_html_e('Check it out','arile-super'); ?></a>
						</div>							
