...
$aasta_project_front_container_size = get_theme_mod('aasta_project_front_container_size', 'container-fluid');
$aasta_project_area_title = get_theme_mod('aasta_project_area_title', __('Our featured works','arile-super'));
$aasta_project_area_des = get_theme_mod('aasta_project_area_des', __('Our Latest Projects','arile-super'));
