<?php
if ( ! class_exists( 'Capital_News_Grid_Posts_Widget' ) ) {
	/**
	 * Adds Capital_News_Grid_Posts_Widget Widget.
	 */
	class Capital_News_Grid_Posts_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$capital_news_grid_posts_widget_ops = array(
				'classname'   => 'grid-posts ascendoor-widget style-1',
				'description' => __( 'Retrive Grid Posts Widgets', 'capital-news' ),
			);
			parent::__construct(
				'capital_news_grid_posts_widget',
				__( 'Ascendoor Grid Posts Widget', 'capital-news' ),
				$capital_news_grid_posts_widget_ops
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show(Min:1 | Max:6):', 'capital-news' ); ?></label>
