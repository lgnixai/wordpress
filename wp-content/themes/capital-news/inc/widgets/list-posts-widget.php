<?php
if ( ! class_exists( 'Capital_News_List_Posts_Widget' ) ) {
	/**
	 * Adds Capital_News_List_Posts_Widget Widget.
	 */
	class Capital_News_List_Posts_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$capital_news_list_posts_widget_ops = array(
				'classname'   => 'list-post ascendoor-widget style-2',
				'description' => __( 'Retrive List Posts Widgets', 'capital-news' ),
			);
			parent::__construct(
				'capital_news_list_posts_widget',
				__( 'Ascendoor List Posts Widget', 'capital-news' ),
				$capital_news_list_posts_widget_ops
			);
		}
