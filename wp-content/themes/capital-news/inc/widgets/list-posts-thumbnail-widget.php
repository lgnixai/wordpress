<?php
if ( ! class_exists( 'Capital_News_List_Posts_Thumbnail_Widget' ) ) {
	/**
	 * Adds Capital_News_List_Posts_Thumbnail_Widget Widget.
	 */
	class Capital_News_List_Posts_Thumbnail_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$capital_news_list_posts_thumbnail_widget_ops = array(
				'classname'   => 'thumbnail-list-post ascendoor-widget style-1',
				'description' => __( 'Retrive List Posts Thumbnail Widgets', 'capital-news' ),
			);
			parent::__construct(
				'capital_news_list_posts_thumbnail_widget',
				__( 'Ascendoor List Posts Thumbnail Widget', 'capital-news' ),
				$capital_news_list_posts_thumbnail_widget_ops
			);
		}
