...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Capital_News_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
	 ...
	 * Title Control
	 */
	class Capital_News_Title_Control extends WP_Customize_Control {
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Capital_News_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'capital-news-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="capital_news_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
