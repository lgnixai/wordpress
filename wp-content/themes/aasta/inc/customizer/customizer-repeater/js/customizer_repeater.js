...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
		...
		if(parentid == 'customize-control-aasta_top_header_info_content')
		{	
			var numItems = jQuery("#customize-control-aasta_top_header_info_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 1){
			  jQuery( "#customize-control-aasta_top_upgrade .aasta-upgrade-pro-message" ).show();
			  return false;   
			}
		}
		
		if(parentid == 'customize-control-aasta_top_header_social_content')
		{	
			var numItems = jQuery("#customize-control-aasta_top_header_social_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 3){ 
			  jQuery( "#customize-control-aasta_social_upgrade .aasta-upgrade-pro-message" ).show();
			  return false;   
			}
		}
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
				...
				var main_social_items = jQuery("#customize-control-aasta_top_header_social_content .customizer-repeater-general-control-repeater-container").length 
				if(main_social_items < 4){ 
				  jQuery( "#customize-control-aasta_social_upgrade .aasta-upgrade-pro-message" ).hide();
				}
