<?php
  ...
  * Slug: clickgrove/single-product
  * Inserter: no
  */
?>
...
<h2 class="wp-block-heading has-text-align-center" style="font-style:normal;font-weight:500"> <?php echo esc_html__( 'Single Product', 'clickgrove' ); ?> </h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related Products', 'clickgrove' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:woocommerce/product-button {"textAlign":"center","isDescendentOfQueryLoop":true,"backgroundColor":"primary","textColor":"heading-text-color","fontSize":"small","style":{"spacing":{"margin":{"bottom":"1rem"}},"elements":{"link":{"color":{"text":"var:preset|color|heading-text-color"}}}}} /-->
