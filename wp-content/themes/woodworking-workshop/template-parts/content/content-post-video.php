...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
	<?php
		$woodworking_workshop_post_id = get_the_ID();
		$woodworking_workshop_post = get_post($woodworking_workshop_post_id);
		$woodworking_workshop_content = do_shortcode(apply_filters('the_content', $woodworking_workshop_post->post_content));
		$woodworking_workshop_embeds = get_media_embedded_in_content($woodworking_workshop_content);

		if (!empty($woodworking_workshop_embeds)) {
			foreach ($woodworking_workshop_embeds as $woodworking_workshop_embed) {
				$woodworking_workshop_embed = wp_kses($woodworking_workshop_embed, array(
					'iframe' => array(
						'src' => array(),
						'width' => array(),
						'height' => array(),
				...
				if (strpos($woodworking_workshop_embed, 'video') !== false || 
					strpos($woodworking_workshop_embed, 'youtube') !== false || 
					strpos($woodworking_workshop_embed, 'vimeo') !== false || 
					strpos($woodworking_workshop_embed, 'dailymotion') !== false || 
					strpos($woodworking_workshop_embed, 'vine') !== false || 
					strpos($woodworking_workshop_embed, 'wordpress.tv') !== false || 
					strpos($woodworking_workshop_embed, 'hulu') !== false) {
					?>
					<div class="custom-embedded-video">
						<div class="video-container">
							<?php echo $woodworking_workshop_embed; ?>
						</div>
