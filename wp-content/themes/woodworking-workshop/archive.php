...
<section class="blog-area inarea-blog-2-column-area three">
	<div class="container">
		<div class="row">
			<?php 
	            $woodworking_workshop_archive_sidebar_setting = get_theme_mod('woodworking_workshop_archive_sidebar_setting','1');
	            $woodworking_workshop_sidebar_position = get_theme_mod('woodworking_workshop_sidebar_position', 'right');
	            $woodworking_workshop_content_class = ($woodworking_workshop_archive_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<?php if( $woodworking_workshop_archive_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
