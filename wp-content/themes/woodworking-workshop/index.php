...
<section class="blog-area inarea-blog-2-column-area three">
	<div class="container">
		<div class="row">
			<?php 
	            $woodworking_workshop_index_sidebar_setting = get_theme_mod('woodworking_workshop_index_sidebar_setting','1');
	            $woodworking_workshop_sidebar_position = get_theme_mod('woodworking_workshop_sidebar_position', 'right');
	            $woodworking_workshop_content_class = ($woodworking_workshop_index_sidebar_setting == '') ? 'col-lg-12' : 'col-lg-8';
			...
			<div class="<?php echo esc_attr($woodworking_workshop_content_class . ' ' . $woodworking_workshop_content_order_class); ?>">
				<div class="row">
					<?php 
						$woodworking_workshop_paged = ( get_query_var('paged') ) ? get_query_var('paged') : 1;
						$args = array( 'post_type' => 'post','paged'=>$woodworking_workshop_paged );	
					?>
					<?php if( have_posts() ): ?>
			...
			<?php if( $woodworking_workshop_index_sidebar_setting != '') { ?> 
                <?php get_sidebar(); ?>
            <?php } ?>
		</div>
	</div>
