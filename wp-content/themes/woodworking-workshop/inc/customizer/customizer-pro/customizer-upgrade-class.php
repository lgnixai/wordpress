...
if ( class_exists( 'WP_Customize_Control' ) ) :
     ...
     * @since 1.0.0
     */
	class Woodworking_Workshop_Control_Upgrade extends WP_Customize_Control {
        ...
        protected function content_template() {
            ?>
                <div class="mt-upgrade-pro-wrapper">
                    ...
                    <# } #>
                    <a class="mt-upgrade-btn" href="<?php echo esc_url( WOODWORKING_WORKSHOP_PRO_THEME_URL ); ?>" target="_blank"><?php esc_html_e( 'upgrade to pro', 'woodworking-workshop' ); ?></a>
                    <a class="mt-upgrade-btn-bundle" href="<?php echo esc_url( WOODWORKING_WORKSHOP_THEME_BUNDLE_URL ); ?>" target="_blank"><?php esc_html_e( 'Buy All Themes', 'woodworking-workshop' ); ?></a>
