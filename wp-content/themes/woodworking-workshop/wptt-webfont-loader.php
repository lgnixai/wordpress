...
if ( ! class_exists( 'Woodworking_Workshop_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Woodworking_Workshop_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Woodworking_Workshop_WPTT_WebFont_Loader( $url );
