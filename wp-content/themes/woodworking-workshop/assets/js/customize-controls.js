( function( $ ) {
  var this_obj = Woodworking_Workshop_Customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'woodworking_workshop_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'woodworking_workshop_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'woodworking_workshop_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'woodworking_workshop_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.woodworking-workshop-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.woodworking-workshop-customizer-tab').removeClass('active');
  ...
  jQuery.extend(api.controlConstructor, {
    'woodworking-workshop-tab': api.Tab
  });
