...
jQuery(document).ready(function(){
    ...
    jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-menu').attr("checked","checked");

    jQuery('#woodworking-workshop-setup-menu').click(function(){
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-menu').css("display","block");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-contact').css("display","none");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-widget').css("display","none");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-social-icon').css("display","none");
    });

    jQuery('#woodworking-workshop-setup-contact').click(function(){
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-menu').css("display","none");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-contact').css("display","block");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-widget').css("display","none");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-social-icon').css("display","none");
    });

    jQuery('#woodworking-workshop-setup-widget').click(function(){
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-menu').css("display","none");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-contact').css("display","none");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-widget').css("display","block");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-social-icon').css("display","none");
    });

    jQuery('#woodworking-workshop-setup-social').click(function(){
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-menu').css("display","none");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-contact').css("display","none");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-widget').css("display","none");
        jQuery('#woodworking-workshop-demo-setup-guid .woodworking-workshop-setup-social-icon').css("display","block");
    });
});