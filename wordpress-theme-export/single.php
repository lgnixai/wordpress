                    ...
                    <div class="max-w-4xl mx-auto text-center">
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-4 text-muted-foreground">
                            ...
                            <span class="flex items-center">
                                ...
                                <?php echo export_theme_reading_time(); ?> min read
                            </span>
                        </div>
                    </div>
                </div>
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class('lg:col-span-2'); ?>>
                            ...
                            ?>
                                <div class="mt-8 pt-8 border-t">
                                    <h3 class="text-sm font-semibold text-muted-foreground mb-3">Tags:</h3>
                            ...
                            <!-- Share Buttons -->
                            <div class="mt-8 pt-8 border-t">
                                <h3 class="text-sm font-semibold text-muted-foreground mb-3">Share this article:</h3>
                            ...
                            <nav class="mt-8 pt-8 border-t">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    ?>
                                        <div>
                                            <p class="text-sm text-muted-foreground mb-1">Previous Article</p>
                                            <a href="<?php echo esc_url(get_permalink($prev_post)); ?>" 
                                               class="flex items-center text-foreground hover:text-primary transition-colors">
                                                <svg class="w-5 h-5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                                                </svg>
                                                <span class="line-clamp-1"><?php echo esc_html($prev_post->post_title); ?></span>
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    ?>
                                        <div class="text-right">
                                            <p class="text-sm text-muted-foreground mb-1">Next Article</p>
                                            <a href="<?php echo esc_url(get_permalink($next_post)); ?>" 
                                               class="flex items-center justify-end text-foreground hover:text-primary transition-colors">
                                                <span class="line-clamp-1"><?php echo esc_html($next_post->post_title); ?></span>
