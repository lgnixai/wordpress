    ...
    <footer id="colophon" class="site-footer bg-gray-900 text-gray-300">
        ...
        <div class="container py-12 md:py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <?php else : ?>
                        ...
                        <?php if ($address = get_theme_mod('export_theme_company_address')) : ?>
                            <p class="text-sm"><?php echo wp_kses_post($address); ?></p>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                ...
                <!-- Products/Services -->
                <div>
                    <h3 class="text-white text-lg font-semibold mb-4">Our Products</h3>
                    ...
                    <?php else : ?>
                        <ul class="space-y-3">
                            <?php if ($phone = get_theme_mod('export_theme_company_phone')) : ?>
                                <li class="flex items-start">
                                    ...
                                    <a href="tel:<?php echo esc_attr($phone); ?>" class="hover:text-white transition-colors">
                        ...
                        <div class="mt-6 flex space-x-4">
                            ...
                            foreach ($social_networks as $network => $icon) {
                                ...
                                if ($url) {
                                    echo '<a href="' . esc_url($url) . '" target="_blank" rel="noopener" class="text-gray-400 hover:text-white transition-colors">' . $icon . '</a>';
                                }
                            }
                            ?>
                        </div>
            ...
            <div class="container py-4">
                <div class="flex flex-col md:flex-row justify-between items-center text-sm">
                    <div class="mb-2 md:mb-0">
                        <?php
                        $copyright = get_theme_mod('export_theme_footer_copyright', '© 2024 Your Company. All rights reserved.');
                        echo wp_kses_post($copyright);
                        ?>
                    </div>
                    <div class="text-center md:text-right">
                        <span class="text-gray-500">Powered by </span>
                        <a href="<?php echo esc_url(__('https://wordpress.org/', 'export-theme')); ?>" class="hover:text-white transition-colors">
                            <?php printf(esc_html__('WordPress', 'export-theme')); ?>
                        </a>
                        <span class="text-gray-500"> | Theme by </span>
